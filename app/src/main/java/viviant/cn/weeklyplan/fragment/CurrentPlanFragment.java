...
import viviant.cn.weeklyplan.apiclient.Event;
import viviant.cn.weeklyplan.apiclient.MyJsonService;
 ...
 */
public class CurrentPlanFragment extends Fragment implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener, Callback<List<Event>> {
    ...
    //add by weiwei.huang2014/04/26 begin
    ...
    //add by weiwei.huang2014/04/26 end
