...
public class RoleFragment extends Fragment {
    ...
    private OnRoleFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onRoleFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnRoleFragmentInteractionListener) activity;
     ...
     */
    public interface OnRoleFragmentInteractionListener {
