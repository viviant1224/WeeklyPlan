...
/**
 * Created by weiwei.huang on 16-4-27.
 */
public abstract class BaseCurrentPlanFragment extends Fragment implements   WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
...
//
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.weekview_day_week, menu);
    }
    ...
    private void setupDateTimeInterpreter(final boolean shortDate) {
        mWeekView.setDateTimeInterpreter(new DateTimeInterpreter() {
            ...
            public String interpretDate(Calendar date) {
                ...
                int curretnWeek = DateUtil.getCurrentWeek();
